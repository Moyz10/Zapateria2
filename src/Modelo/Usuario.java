...
public class Usuario {
	...
	private String user, pass, tipo, nombre, curp, correo, telefono;
	...
	public Usuario(String user, String pass, String tipo, String nombre, String curp, String correo, String telefono) {
		this.user = user;
		this.pass = pass;
		this.tipo = tipo;
		this.nombre = nombre;
