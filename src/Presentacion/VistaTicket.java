...
public class VistaTicket extends JFrame {
	...
	private JButton btnCancelar, btnImprimir;
	private JLabel lbldFolio, lbldFecha, lbldModelo, lbldColor, lbldTalla, lbldCantidad, lbldPrecioUnitario, lbldIVA,
			lbldTotal;
	...
	private void iniciarComponentes() {
		...
		Ticket.setBounds(10, 10, 430, 470);
		...
		Ticket.add(lblIcon);
		ImageIcon imgIcon = new ImageIcon(VistaTicket.class.getResource("Ticket.png"));
		...
		lblCantidad.setBounds(40, 290, 140, 26);
		...
		lbldPrecioUnitario.setBounds(200, 320, 160, 26);
	...
	public String[] obtenerDatosTicket() {
		String[] datos = { lbldFolio.getText(), lbldFecha.getText(), lbldModelo.getText(), lbldColor.getText(),
				lbldTalla.getText(), lbldCantidad.getText(), lbldPrecioUnitario.getText(), lbldIVA.getText(),
				lbldTotal.getText() };
		return datos;
	}
